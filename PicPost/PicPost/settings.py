...
SECRET_KEY = 'rzfm40)@%ft6g-w_++!!kq*95mt9-trj23xhy1qm7fky^a&37%'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": ["redis://:pef6648d6a4b9e9b86dcac262637d7bc5b8fe9834e52560d0231a171805485b12@ec2-52-210-1-88.eu-west-1.compute.amazonaws.com:6910"],
        },
    },
}
